...
build_time_vars = {'ABIFLAGS': 'dm',
 ...
 'BLDSHARED': 'gcc -pthread -shared -Wl,-z,relro -Wl,--as-needed  -Wl,-z,now  '
              '-g',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIG_ARGS': "'--build=x86_64-redhat-linux-gnu' "
                ...
                "-fwrapv ' 'LDFLAGS= -Wl,-z,relro -Wl,--as-needed  -Wl,-z,now  "
                "-g ' 'CPPFLAGS=' "
                "'PKG_CONFIG_PATH=:/usr/lib64/pkgconfig:/usr/share/pkgconfig'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python3.7dm',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/builddir/build/BUILD/Python-3.7.7/build/debug/coverage.info',
 'COVERAGE_REPORT': '/builddir/build/BUILD/Python-3.7.7/build/debug/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. '
             '-I/builddir/build/BUILD/Python-3.7.7/Include',
 'CXX': 'g++ -pthread',
 ...
 'LDFLAGS': '-Wl,-z,relro -Wl,--as-needed  -Wl,-z,now  -g',
 'LDLAST': '',
 ...
 'MAKESETUP': '/builddir/build/BUILD/Python-3.7.7/Modules/makesetup',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare '
                             ...
                             '-m64 -mtune=generic -fasynchronous-unwind-tables '
                             '-fstack-clash-protection -fcf-protection '
                             '-D_GNU_SOURCE -fPIC -fwrapv -Og -IObjects '
                             '-IInclude -IPython -I. '
                             '-I/builddir/build/BUILD/Python-3.7.7/Include '
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare '
                   ...
                   '-mtune=generic -fasynchronous-unwind-tables '
                   '-fstack-clash-protection -fcf-protection -D_GNU_SOURCE '
                   '-fPIC -fwrapv -Og -IObjects -IInclude -IPython -I. '
                   '-I/builddir/build/BUILD/Python-3.7.7/Include '
                   '-DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-Wl,-z,relro -Wl,--as-needed  -Wl,-z,now  -g -Wl,-z,relro '
 ...
 'PY_CPPFLAGS': '-IObjects -IInclude -IPython -I. '
                '-I/builddir/build/BUILD/Python-3.7.7/Include',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-Wl,-z,relro -Wl,--as-needed  -Wl,-z,now  -g',
 ...
 'PY_STDMODULE_CFLAGS': '-Wno-unused-result -Wsign-compare '
                        ...
                        '-mtune=generic -fasynchronous-unwind-tables '
                        '-fstack-clash-protection -fcf-protection '
                        '-D_GNU_SOURCE -fPIC -fwrapv -Og -IObjects -IInclude '
                        '-IPython -I. '
                        '-I/builddir/build/BUILD/Python-3.7.7/Include',
 'Py_DEBUG': 1,
 'Py_ENABLE_SHARED': 1,
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/builddir/build/BUILD/Python-3.7.7/build/debug',
 'SCRIPTDIR': '/usr/lib64',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '@SGI_ABI@',
 'SHELL': '/bin/sh',
 ...
 'SRC_GDB_HOOKS': '/builddir/build/BUILD/Python-3.7.7/Tools/gdb/libpython.py',
 'STDC_HEADERS': 1,
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/builddir/build/BUILD/Python-3.7.7/build/debug '
               './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/builddir/build/BUILD/Python-3.7.7/build/debug '
 ...
 'UPDATE_FILE': 'python3.7 '
                '/builddir/build/BUILD/Python-3.7.7/Tools/scripts/update_file.py',
 'USE_COMPUTED_GOTOS': 1,
 'VERSION': '3.7',
 'VPATH': '/builddir/build/BUILD/Python-3.7.7',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'abs_builddir': '/builddir/build/BUILD/Python-3.7.7/build/debug',
 'abs_srcdir': '/builddir/build/BUILD/Python-3.7.7',
 'datarootdir': '/usr/share',
 'exec_prefix': '/usr',
 'prefix': '/usr',
 'srcdir': '/builddir/build/BUILD/Python-3.7.7'}
